...
export default function Target() {
    ...
    function handleSave() {
        if (!name.trim() || amount <= 0) {
            return Alert.alert("Atenção", "Preencha nome e o valor precisar ser maior que zero.")
        }
    ...
    async function remove(){
        try {
            ...
            Alert.alert("Erro", "Não foi possível remover sua meta.")
            console.log(error)
        }
    }
    ...
    return (
        <View style={{ flex: 1, padding: 24 }}>
            ...
            <View style={{ marginTop: 32, gap: 24 }}>
                ...
                <Input label="Nome da meta" placeholder="Ex: Viagem para praia, 5090" onChangeText={setName} value={name} />
